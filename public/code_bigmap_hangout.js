    ...
    $.ajax({
      ...
      success: function(result){
        result.forEach((item, i) => {
          ...
          if((str.match(/hangout/i)) || (str.match(/chill/i)) || (str.match(/relax/i)) || (str.match(/park/i)) || (str.match(/trip/i)) || (str.match(/walk/i)) || (str.match(/tourist/i)) || (str.match(/vacation/i)) )
